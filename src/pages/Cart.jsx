...
// import { ArrowBigLeftDash, Zap  } from 'lucide-react'; 
// import { useCart } from '../Context/CartContext';

// const Cart = () => {

//   const {cartCount , cart,cartTotal, CartItem} = useCart();
...
//           <button className='flex gap-2 items-center mb-5 text-gray-500 text-sm font-semibold hover:text-amber-600 transition duration-300'>
//             <ArrowBigLeftDash />
//             <span>
//               Back to Store
//             </span>
...
//           <h1 className='font-extrabold text-4xl tracking-tight'>Shopping Cart ({cartCount})</h1>

//             <div className='grid grid-cols-1 lg-grid-col-3 gap-10'>
