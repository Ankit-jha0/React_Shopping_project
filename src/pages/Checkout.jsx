...
const Checkout = () => {
  ...
  if(isConfirmed){
    console.log( "name = ", name,'address = ', address,' city = ', city, 'zip = ',  zip);
    return <OrderConfimation name={name} address={address} city={city} zip={zip} />
  }
          ...
          <div className="lg:col-span-2 p-8 bg-gray-900 rounded-2xl shadow-2xl border border-gray-800">
            ...
            <form className="space-y-6" onSubmit={handleSumbit}>
              ...
              <label className="block">
                <span className="block text-sm font-semibold text-gray-300 capitalize mb-1">
                  Name
                </span>
                <input
                  type="text"
